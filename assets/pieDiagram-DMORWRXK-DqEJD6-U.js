import{p as U}from"./chunk-K2ZEYYM2-Dbt9BIwq.js";import{p as q}from"./treemap-KMMF4GRG-YVX6V4UE-C7zYFGvk.js";import{_ as s,g as H,s as V,a as Z,b as j,t as J,q as K,l as w,c as Q,F as X,a6 as Y,a8 as ee,a9 as G,aa as te,e as ae,z as re,ab as ie,H as se}from"./index-DniIGSMF.js";import"./chunk-ZZTYOBSU-CPxr121E.js";import"./mermaid-Bpr93w1e.js";var le=se.pie,D={sections:new Map,showData:!1},g=D.sections,C=D.showData,oe=structuredClone(le),ne=s(()=>structuredClone(oe),"getConfig"),ce=s(()=>{g=new Map,C=D.showData,re()},"clear"),de=s(({label:e,value:a})=>{if(a<0)throw new Error(`"${e}" has invalid value: ${a}. Negative values are not allowed in pie charts. All slice values must be >= 0.`);g.has(e)||(g.set(e,a),w.debug(`added new section: ${e}, with value: ${a}`))},"addSection"),pe=s(()=>g,"getSections"),ge=s(e=>{C=e},"setShowData"),ue=s(()=>C,"getShowData"),W={getConfig:ne,clear:ce,setDiagramTitle:K,getDiagramTitle:J,setAccTitle:j,getAccTitle:Z,setAccDescription:V,getAccDescription:H,addSection:de,getSections:pe,setShowData:ge,getShowData:ue},fe=s((e,a)=>{U(e,a),a.setShowData(e.showData),e.sections.map(a.addSection)},"populateDb"),he={parse:s(async e=>{const a=await q("pie",e);w.debug(a),fe(a,W)},"parse")},me=s(e=>`
  .pieCircle{
